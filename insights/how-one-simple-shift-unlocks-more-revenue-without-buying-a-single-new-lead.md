...
That matters because reactivation is often **5 to 25 times cheaper than acquiring a new customer**, according to [Automate to Grow](https://automizetogrow.com). For service businesses, that changes the math fast.
...
Lead generation costs keep rising. In high-cost categories, cost per lead can exceed **$500+**, according to [Martal](https://martal.ca). So when a business ignores people already in its database, it is paying twice - once to acquire the lead, then again to replace it.
...
Research from [AI Agents Plus](https://aiagentsplus.com) shows that **5% to 15% of dormant contacts re-engage**, and **2% to 5% convert into appointments or purchases** when reactivation is done well. That is not a vanity metric. That is a revenue channel.

### Simple Example

If a business has **1,000 dormant contacts** and reactivates just **5%**, that is **50 revived opportunities**. At an average customer value of **$300**, that equals **$15,000 in recovered revenue** from a list the business already owns.
...
[Business.com](https://business.com) reports that SMS has a **98% open rate**, a **45% average response rate**, and **90% of messages are read within three minutes**. Email is not close on immediacy - email response rates sit around **6%**, with only about **21% read in the first hour**.
...
This is where most businesses get it wrong. They blast old leads with generic offers instead of opening a human conversation. [58% of marketers report that SMS effectively re-engages lapsed customers](https://fdry.co) - but only when the message earns a reply, not just an open.
...
[Martal reports](https://martal.ca) that **businesses using AI see 50% to 60% lower acquisition costs overall**. That does not just matter for new lead generation - it also strengthens reactivation by making follow-up more targeted and more cost-efficient.
...
[Ambs Call Center's 2025 study](https://ambscallcenter.com) found that **62% of inbound calls go unanswered** on average. The same study found that **85% of callers never call back**, and **62% switch to a competitor after a missed call**.

That is not a lead problem. That is a capture problem.

### The Cost of Not Responding

Aggregated data from Invoca, Dialora.ai, and other call intelligence sources estimates that missed calls cost the average business about **$126,000 per year** in lost revenue. For service businesses in home services specifically, the average missed call costs between **$300 and $1,200** depending on the job type.
...
1.  Capture every inbound lead fast
2.  Reactivate the database already in the CRM
3.  Recover missed calls and stalled conversations
4.  Then scale acquisition once conversion improves
...
**Ready to see what is sitting in your database?** Use the [Lost Revenue Calculator](https://lostrevenue.audienceintent.ai) to estimate what untouched leads could be worth - or [get a free Business Performance Report](https://report.audienceintent.ai) to see exactly where revenue is leaking right now.
