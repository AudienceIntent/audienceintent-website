...
Every lead in your database cost something to generate, whether through paid ads, referrals, trade shows, or organic search. If your average cost per lead was $50 and you have 5,000 contacts sitting untouched, that is $250,000 in acquired attention going nowhere.
...
-   **Cold traffic:** High acquisition cost, low familiarity, low trust
    
-   **Dormant leads:** Already acquired, already aware, just needs the right follow-up
    
-   **Past customers:** Highest conversion potential of any segment
...
According to [2026 SMS benchmarks from AudienceTap](https://www.audiencetap.com/blog/sms-marketing-statistics), SMS consistently outperforms email across every engagement metric that matters for reactivation:

| Metric | SMS | Email |
| --- | --- | --- |
| Open rate | 90-98% | 20-36% |
| Response rate | 45%+ | ~6% |
| Click-through rate | 18-45% | 1.3-2.6% |
| Conversion rate | 21-30% | 1.9-5% |
...
[Research from Leadinfo](https://www.leadinfo.com) shows that conversion chances drop by 80% if follow-up is delayed beyond five minutes. That applies to new leads, but the same principle holds for reactivation: when a dormant contact responds to a message, clicks a link, or revisits a service page, the window to convert them is short.
...
For service businesses running on appointment-based models, a missed response at the reactivation moment is no different from a missed call. [According to data compiled by LeadsOrbit](https://leadorbit.ai), 85% of missed callers never call back. The same drop-off applies to re-engaged leads who get no response.
...
-   **Prior written consent:** Contacts must have opted in to receive SMS marketing from your business. A form fill, a purchase, or an inquiry that included SMS consent language qualifies. Purchased lists with no consent history do not.
    
-   **Clear opt-out language:** Every message must include a simple way to stop receiving texts, typically "Reply STOP to unsubscribe."
    
-   **Sender identification:** Each message must clearly identify the business sending it.
    
-   **Reasonable send times:** TCPA guidelines restrict outbound messages to between 8am and 9pm in the recipient's local time zone.
...
-   **HVAC company:** Reaches out to leads who requested estimates during the previous season before peak demand hits. Offer: priority scheduling.
    
-   **Legal firm:** Follows up with contacts who downloaded a guide or attended a webinar but never booked a consult. Offer: free 15-minute case review.
    
-   **Med spa:** Re-engages past clients who have not visited in six months. Offer: a returning client discount on a specific treatment they previously received.
    
-   **Roofing contractor:** Contacts homeowners who received an estimate but did not sign. Offer: updated estimate with current material pricing.
...
**Use the** [**Lost Revenue Calculator**](https://lostrevenue.audienceintent.ai) **to see what your dormant leads may actually be worth.** Or [book a strategy call](https://api.leadconnectorhq.com/widget/booking/Bxb438yeUpuxV0peTRmi) to map out a reactivation campaign built around your CRM, your industry, and your compliance requirements.
...
Use the [Lost Revenue Calculator at lostrevenue.audienceintent.ai](https://lostrevenue.audienceintent.ai) to estimate the revenue potential sitting in your existing CRM based on your list size, average job value, and typical conversion rate. Most service businesses are surprised by the number.
