---
title: How to Calculate ROI from Lead Reactivation Campaigns (With Real Numbers)
...
-   **Revenue Recovered:** The total closed revenue attributed to leads who re-engaged during the campaign. This means signed contracts, booked jobs, completed sales — not pipeline or "warm conversations."
    
-   **Campaign Cost:** Everything you paid to run the reactivation effort. This includes agency fees, software, any upfront setup charges, and the cost of your team's time if they handled follow-up manually.
    
-   **Net Revenue:** Revenue Recovered minus Campaign Cost. This is your actual profit from the campaign before factoring in your cost of goods or service delivery.
...
| Database Size | Leads Reactivated | Deals Closed | Revenue Recovered | Campaign Cost (15%) | **ROI** |
| --- | --- | --- | --- | --- | --- |
| Small (500 leads) | 25 | 6 | $15,000 | $2,250 | **567%** |
| Medium (2,000 leads) | 100 | 25 | $62,500 | $9,375 | **567%** |
| Large (10,000 leads) | 500 | 125 | $312,500 | $46,875 | **567%** |
...
| Variable | Value |
| --- | --- |
| Database size | 1,800 leads |
| Reactivation rate | 5% |
| Leads reactivated | 90 |
| Close rate | 30% |
| Deals closed | 27 |
...
| 500% and above | Excellent. Optimize and repeat. |
...
If you want to run the math on your specific list size, average deal value, and industry before talking to anyone, [AudienceIntent's Lost Revenue Calculator](https://lostrevenue.audienceintent.ai) walks through the same formula above with your actual inputs. It takes about two minutes and gives you a realistic revenue range based on your database, not a generic projection.
