---
title: Questions We Get Asked About Database Reactivation (And the Honest Answers)
meta_title: "Database Reactivation FAQ: Honest Answers That Matter"
date: 2026-05-29T16:13:00.000-04:00
...
og_image: https://www.audienceintent.ai/images/uploads/database.jpg
schema: >-
  {
    "@graph": [
      {
...
-   **Consent documentation.** The older the list, the more important it is that you can verify TCPA-compliant opt-in. We'll cover this in detail below.
    
-   **Number validity.** People change phones. Expect some bounce rate on older lists. That's normal and accounted for.
    
-   **Realistic expectations.** A list from three years ago will perform differently than one from six months ago. We set expectations clearly before launch, not after.
...
-   A web form with an SMS opt-in checkbox or disclosure
    
-   A point-of-sale signup where they provided their number for follow-up
    
-   An inbound inquiry where they contacted you first
    
-   A lead generation campaign where the opt-in language was explicit
...
-   **"Not interested"** — acknowledged, thanked for their time, removed from the sequence.
    
-   **"STOP" or opt-out language** — immediate suppression, no further messages, ever.
    
-   **Frustrated or hostile reply** — the AI de-escalates, doesn't match the tone, exits gracefully. Your brand stays clean.
...
If your average job or sale is worth $2,000, then even 10 reactivated customers from a small list is $20,000 in recovered revenue. That math works. If your average transaction is $50, the numbers look very different.

Use the [Lost Revenue Calculator](https://lostrevenue.audienceintent.ai) to run your own numbers before committing to anything. Plug in your list size, your average transaction value, and a conservative reactivation rate. The output tells you whether the opportunity is worth pursuing, without any guesswork.
...
Once the campaign is live, replies typically start coming in within hours. Booked appointments usually follow within 24 to 72 hours of launch. The reason is simple: SMS has a [98% open rate](https://www.linkedin.com/pulse/sms-marketing-statistics-2024-comprehensive-guide-marketers/), and most messages are read within minutes of delivery. You're not waiting for someone to check their email inbox three days later.

### A realistic timeline

| Timeframe | What to expect |
| --- | --- |
| Days 1–5 | Onboarding, copy review, campaign build |
| Day 5–7 | Campaign goes live |
| Hours after launch | First replies coming in |
| Days 1–3 post-launch | Initial booked appointments |
| Days 7–14 | Bulk of campaign responses settled |
| Day 30 | Full campaign performance picture |
...
-   Copy: we write all messages, including follow-up sequences
    
-   Sequences: we build the full conversation flow
    
-   Responses: the AI handles replies, including objections and opt-outs
    
-   Reporting: we track and report every metric that matters
    
-   Optimization: we adjust based on what's working mid-campaign
    

What it doesn't cover: your sales process after the handoff. If your team is slow to follow up with interested leads, that's where revenue leaks. The [research is clear on this](https://www.leadresponsemanagement.org/lrm_study): the first business to respond wins 78% of leads. We get people to raise their hand. You need to be ready to catch them.
...
-   **26% conversion rate** on our campaign
    
-   **$17.62 revenue per click**
    
-   Ranked #1 above the internal team on CTR, Average Order Value, and Revenue Per Message
...
The full breakdown is on our [results page](https://results.audienceintent.ai). We don't publish vague "up to X%" claims. We publish the actual numbers from named clients who agreed to be cited.
...
-   **Your list came from a third-party purchase.** We won't run purchased lists. Full stop.
...
If you want to know what your specific list might be worth before committing to anything, run the numbers yourself at [lostrevenue.audienceintent.ai](https://lostrevenue.audienceintent.ai). Two minutes, no signup required.
