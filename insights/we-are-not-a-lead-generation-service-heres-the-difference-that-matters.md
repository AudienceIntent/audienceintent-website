---
title: We Are Not a Lead Generation Service. Here's the Difference That Matters.
...
image: /images/uploads/lead-generation.jpg
...
-   **You already own this asset.** You paid to acquire those leads. Every one of them represents ad spend, sales effort, or referral capital that never converted into revenue.
    
-   **The compliance picture is completely different.** Reaching out to people who gave you their contact information and opted in to hear from you is legally and operationally distinct from cold outreach to purchased or scraped lists.
...
| Factor | Lead Generation | Database Reactivation |
| --- | --- | --- |
| **Who you're contacting** | People who have never heard of you | People who already know your business |
| **Where the contact came from** | Purchased list, scraped data, or third-party form | Your own CRM, your own opt-in records |
| **Consent status** | Often unclear or shared across multiple sellers | Direct, documented, specific to your business |
| **SMS legal standing** | High risk without verified one-to-one consent | Compliant when opt-in records are intact |
| **Cost structure** | You pay for every lead regardless of outcome | Performance-based: you pay when revenue is generated |
...
-   **Prior express written consent.** The contact gave explicit, documented permission to receive SMS marketing messages from your business specifically. A pre-checked box does not count. Verbal consent alone does not meet the written standard for marketing texts.
    
-   **Consent specific to your business.** Under the January 2025 FCC rule, broad consent listing multiple "marketing partners" is no longer valid. The consent must name your business directly.
    
-   **Stored and retrievable records.** You must be able to demonstrate when, where, and how consent was captured. If you can't produce the record, the consent is effectively unverifiable.
    
-   **No prior opt-out.** If a contact previously replied STOP, unsubscribed, or communicated through any reasonable method that they no longer want to be contacted, they are removed before any campaign launches.
...
If you want to see what your specific database might be worth, the [Lost Revenue Calculator](https://lostrevenue.audienceintent.ai) runs the numbers based on your list size, average transaction value, and industry benchmarks. It takes about 60 seconds.

![AudienceIntent Lost Revenue Calculator showing dormant CRM lead value for database reactivation campaigns](https://app.searchable.com/api/i/67d3153b-e796-4a82-978e-c57181fbe69c)
...
Age alone does not invalidate consent. A contact who opted in two years ago and never opted out still has valid consent on record. That said, very old lists can have higher rates of disconnected numbers, changed numbers, and contacts who have moved on. We triage lists before launch to identify and remove these, which improves deliverability and keeps your campaign metrics clean. For a detailed breakdown of how lead age affects reactivation, see our guide on [how old a lead can be before it is no longer worth contacting](https://audienceintent.ai/insights/how-old-can-a-lead-be-before-it-is-no-longer-worth-contacting).
...
Yes. The [Lost Revenue Calculator](https://lostrevenue.audienceintent.ai) estimates the potential value of your dormant list based on your industry, list size, and average transaction value. It is free and takes about 60 seconds. If the numbers make sense, [book a call](https://api.leadconnectorhq.com/widget/booking/Bxb438yeUpuxV0peTRmi) and we will walk through your specific situation.
